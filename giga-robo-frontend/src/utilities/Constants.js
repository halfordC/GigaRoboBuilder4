...
const ENDPOINTS =
{
    ...
    GET_ALL_ROBOT_ABILITIES: 'getAllRobotAbilites',
    GET_ALL_PILOT_ABILITIES: 'getAllPilotAbilites',
    GET_ALL_ROBOT_CARDS: 'getAllRobotCards',
    GET_ALL_PILOT_CARDS: 'getAllPilotCards',
...
const development = 
{
    ...
    API_URL_GET_ALL_ROBOT_ABILITIES: `${API_BASE_URL_DEVELOPMENT}/${ENDPOINTS.GET_ALL_ROBOT_ABILITIES}`,
    API_URL_GET_ALL_PILOT_ABILITIES: `${API_BASE_URL_DEVELOPMENT}/${ENDPOINTS.GET_ALL_PILOT_ABILITIES}`,
    API_URL_GET_ALL_ROBOT_CARDS: `${API_BASE_URL_DEVELOPMENT}/${ENDPOINTS.GET_ALL_ROBOT_CARDS}`,
    API_URL_GET_ALL_PILOT_CARDS: `${API_BASE_URL_DEVELOPMENT}/${ENDPOINTS.GET_ALL_PILOT_CARDS}`,
...
const production = 
{
    ...
    API_URL_GET_ALL_ROBOT_ABILITIES: `${API_BASE_URL_PRODUCTION}/${ENDPOINTS.GET_ALL_ROBOT_ABILITIES}`,
    API_URL_GET_ALL_PILOT_ABILITIES: `${API_BASE_URL_PRODUCTION}/${ENDPOINTS.GET_ALL_PILOT_ABILITIES}`,
    API_URL_GET_ALL_ROBOT_CARDS: `${API_BASE_URL_PRODUCTION}/${ENDPOINTS.GET_ALL_ROBOT_CARDS}`,
    API_URL_GET_ALL_PILOT_CARDS: `${API_BASE_URL_PRODUCTION}/${ENDPOINTS.GET_ALL_PILOT_CARDS}`,
